...
'''))
    print(f'''
{Fore.LIGHTWHITE_EX}                                   Made by {Fore.YELLOW}Chaduneli
{Fore.LIGHTWHITE_EX}Check Out The Discord Server For The Updates: {Fore.LIGHTBLUE_EX}https://discord.gg/hdX3FSHh2K         
...
def start():
    @client.event
    async def on_ready():
        await client.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.watching, name="https://discord.gg/hdX3FSHh2K"))
        os.system('cls' if os.name == 'nt' else 'clear')
        return await main()
